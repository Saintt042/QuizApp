...
continue_btn.onclick = ()=>{
    info_box.classList.remove("activeInfo"); //hide the quiz box
...
function optionSelected(answer){
    ...
    if(userAns == correctAns){
        ...
        console.log("You are a mumu pussy");
...
function showResultBox(){
    ...
    if(userScore > 25){
        let scoreTag = '<span>and Congrats Champ, You got <p>'+ userScore +'</p>out of<p>'+ questions.length +'</p></span>'
        ...
        let scoreTag = '<span>and sorry 😭😓, You got just<p>'+ userScore +'</p>out of<p>'+ questions.length +'</p></span>'
        scoreText.innerHTML = scoreTag;
    }
}
...
function startTimer(time){
    ...
    function timer(){
        ...
        if(time < 0){
            ...
            timeOff.textContent = "Oops! think faster darling"
